...
string img_path = "imageBoite1.jpg";  // image to register
string ply_read_path = "boxtest.ply";          // object mesh
string write_path ="box2_ORB.yml";     // output file

														   // Boolean the know if the registration it's done
bool end_registration = false;


double params_CANON[] = { 708,   // fx
708,  // fy
320,      // cx
240 };    // cy
...
int main(int argc, char *argv[])
{
	...
	cout << "list of triangle " << (int)mesh.getTrianglesList().size();
	...
	cout << "Click the object corners ..." << endl;
	cout << "Waiting ..." << endl;
